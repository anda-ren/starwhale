...
public class JobCreator {
    ...
    private final DatasetDao datasetService;
    ...
    public JobCreator(JobBoConverter jobBoConverter,
            ...
            DatasetDao datasetService, RuntimeService runtimeService, JobUpdateHelper jobUpdateHelper,
    ...
    public Job createJob(Project project,
        ...
        var datasetVersionIdMaps = StringUtils.hasText(datasetVersionUrls)
                ...
                .map(datasetService::getDatasetVersion)
